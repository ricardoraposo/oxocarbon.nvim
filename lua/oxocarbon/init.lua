...
vim.api.nvim_set_hl(0, "TelescopeBorder", {fg = oxocarbon.none, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "TelescopePromptBorder", {fg = oxocarbon.none, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "TelescopePromptNormal", {fg = oxocarbon.none, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "TelescopePromptTitle", {fg = oxocarbon.base02, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "NvimTreeNormal", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NvimTreeNormalFloat", {fg = oxocarbon.base04, bg = oxocarbon.none})
